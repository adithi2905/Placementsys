...
for(Post p:post)
{
	...
	out.print("<span><b>Job Id:</b>"+p.getJobid()+"<br><b>Company:</b>  "+p.getCompany()+"<br><b>Job Title:</b>  "+p.getTitle()+"<br><b>Location:</b>  "+p.getLocation()+"<br><b>Applicable Depts:</b>  "+p.getDept()+"<br><b>Presentation Date:</b>  "+p.getPresd()+"<br><b>Online Test Date:</b>  "+p.getOnd()+"<br><b>Interview Date:</b>  "+p.getInd()+"<br><br>"+"</span>");
